...
class main():
    ...
    def logic(self):
        ...
        print("Increments of 10 of L*A*B: q, w, e")
        print("Decrements of 10 of L*A*B: a, s, d")
        print("Increments of 10 of Threshold: r")
        print("Decrements of 10 of Threshold: f")
    ...
    def display_cam(self):
        while True:
            ...
            #self.cam.displayColorFilters(select=self.thiscolor, l=self.l, a=self.a, b=self.b)
